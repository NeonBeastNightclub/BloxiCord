...
client.on('ready', () => {
  ...
  case "support":
if (message.channel == 416284519453163521){
...
break ;  
    ...
    message.reply("This command can only run in our server's customer support channel. Please run `~join` to join our discord!);
                  break;
  };
